...
\textbf{SuperLU fallback:} single-threaded, wall time not measured
at $N = 48$ (order-of-magnitude expectation: PARDISO time
multiplied by thread count minus threading efficiency losses).
\end{grayb}
