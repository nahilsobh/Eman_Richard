...
Fifteen voxels sampled from the $48^3$ production grid — all values
in \si{\kilo\pascal}, axis convention $(0, 1, 2) = (z, y, x)$. The
first four rows sit at the \emph{same radius} $r = 39.5$~mm (nearest
grid voxel to the cavity edge) on four different Cartesian axes,
demonstrating how the rotation reshuffles the Cartesian entries
without changing the eigenvalues.

\vspace{2pt}
\begin{center}
\scriptsize
\textbf{Phantom P1 (neo-Hookean, $\mu_0 = 3530$~Pa)}\\[2pt]
\begin{tabular}{@{}lrrrr|rrrrrr|rr@{}}
\toprule
Voxel & $r$ (mm) & $\hat r_z$ & $\hat r_y$ & $\hat r_x$ & $\mu_{zz}$ & $\mu_{yy}$ & $\mu_{xx}$ & $\mu_{zy}$ & $\mu_{zx}$ & $\mu_{yx}$ & $\mu_{rr}$ & $\mu_{\theta\theta}$ \\
\midrule
shell $-z$ axis            & 39.5  & $-$0.998 & $+$0.048 & $+$0.048 & 0.519 & 9.577 & 9.577 & $+$0.432 & $+$0.432 & $-$0.021 & 0.478 & 9.598 \\
shell $+z$ axis            & 39.5  & $+$0.998 & $+$0.048 & $+$0.048 & 0.519 & 9.577 & 9.577 & $-$0.432 & $-$0.432 & $-$0.021 & 0.478 & 9.598 \\
shell $-y$ axis            & 39.5  & $+$0.048 & $-$0.998 & $+$0.048 & 9.577 & 0.519 & 9.577 & $+$0.432 & $-$0.021 & $+$0.432 & 0.478 & 9.598 \\
shell $+x$ axis            & 39.5  & $+$0.048 & $+$0.048 & $+$0.998 & 9.577 & 9.577 & 0.519 & $-$0.021 & $-$0.432 & $-$0.432 & 0.478 & 9.598 \\
shell off-axis $(-,+,+)$   & 42.2  & $-$0.755 & $+$0.577 & $+$0.311 & 3.495 & 4.912 & 6.328 & $+$2.608 & $+$1.405 & $-$1.074 & 0.922 & 6.906 \\
shell off-axis $(+,-,+)$   & 43.2  & $+$0.825 & $-$0.477 & $+$0.304 & 2.781 & 5.198 & 5.924 & $+$2.106 & $-$1.340 & $+$0.776 & 1.068 & 6.417 \\
shell outer               & 50.7  & $-$0.703 & $+$0.629 & $+$0.333 & 3.371 & 3.653 & 4.468 & $+$1.266 & $+$0.670 & $-$0.600 & 1.920 & 4.786 \\
shell outer $(+,-,+)$      & 53.7  & $+$0.664 & $-$0.594 & $+$0.454 & 3.476 & 3.684 & 4.030 & $+$0.931 & $-$0.712 & $+$0.637 & 2.156 & 4.517 \\
post-shell inner           & 63.7  & $-$0.736 & $+$0.559 & $+$0.383 & 3.311 & 3.621 & 3.846 & $+$0.557 & $+$0.381 & $-$0.290 & 2.689 & 4.044 \\
post-shell outer           & 81.2  & $-$0.716 & $+$0.577 & $+$0.393 & 3.429 & 3.543 & 3.658 & $+$0.265 & $+$0.180 & $-$0.145 & 3.116 & 3.757 \\
mid-domain                 & 100.3 & $-$0.692 & $+$0.580 & $+$0.430 & 3.485 & 3.533 & 3.584 & $+$0.135 & $+$0.100 & $-$0.084 & 3.309 & 3.646 \\
far corner $(+,+,+)$        & 139.6 & $+$0.577 & $+$0.577 & $+$0.577 & 3.530 & 3.530 & 3.530 & $-$0.041 & $-$0.041 & $-$0.041 & 3.448 & 3.572 \\
far corner $(-,-,+)$        & 135.4 & $-$0.568 & $-$0.568 & $+$0.596 & 3.532 & 3.532 & 3.528 & $-$0.044 & $+$0.046 & $+$0.046 & 3.440 & 3.576 \\
balloon interior           &   3.2 & ---      & ---      & ---      & 0.001 & 0.001 & 0.001 & \phantom{$-$}0.000 & \phantom{$-$}0.000 & \phantom{$-$}0.000 & 0.001 & 0.001 \\
\bottomrule
\end{tabular}

\vspace{6pt}
\textbf{Phantom P2 (matrix + power-law fibre, $\mu_0 = 3340$~Pa)}\\[2pt]
\begin{tabular}{@{}lrrrr|rrrrrr|rr@{}}
\toprule
Voxel & $r$ (mm) & $\hat r_z$ & $\hat r_y$ & $\hat r_x$ & $\mu_{zz}$ & $\mu_{yy}$ & $\mu_{xx}$ & $\mu_{zy}$ & $\mu_{zx}$ & $\mu_{yx}$ & $\mu_{rr}$ & $\mu_{\theta\theta}$ \\
\midrule
shell $-z$ axis            & 39.5  & $-$0.998 & $+$0.048 & $+$0.048 & 0.722  & 13.334 & 13.334 & $+$0.602 & $+$0.602 & $-$0.029 & 0.665 & 13.363 \\
shell $+z$ axis            & 39.5  & $+$0.998 & $+$0.048 & $+$0.048 & 0.722  & 13.334 & 13.334 & $-$0.602 & $-$0.602 & $-$0.029 & 0.665 & 13.363 \\
shell $-y$ axis            & 39.5  & $+$0.048 & $-$0.998 & $+$0.048 & 13.334 & 0.722  & 13.334 & $+$0.602 & $-$0.029 & $+$0.602 & 0.665 & 13.363 \\
shell $+x$ axis            & 39.5  & $+$0.048 & $+$0.048 & $+$0.998 & 13.334 & 13.334 & 0.722  & $-$0.029 & $-$0.602 & $-$0.602 & 0.665 & 13.363 \\
shell off-axis $(-,+,+)$   & 42.2  & $-$0.755 & $+$0.577 & $+$0.311 & 4.297  & 6.038  & 7.780  & $+$3.207 & $+$1.727 & $-$1.320 & 1.134 & 8.491 \\
shell off-axis $(+,-,+)$   & 43.2  & $+$0.825 & $-$0.477 & $+$0.304 & 3.323  & 6.212  & 7.079  & $+$2.516 & $-$1.601 & $+$0.927 & 1.276 & 7.669 \\
shell outer               & 50.7  & $-$0.703 & $+$0.629 & $+$0.333 & 3.584  & 3.884  & 4.751  & $+$1.346 & $+$0.713 & $-$0.638 & 2.042 & 5.089 \\
shell outer $(+,-,+)$      & 53.7  & $+$0.664 & $-$0.594 & $+$0.454 & 3.611  & 3.826  & 4.185  & $+$0.967 & $-$0.739 & $+$0.662 & 2.239 & 4.691 \\
post-shell inner           & 63.7  & $-$0.736 & $+$0.559 & $+$0.383 & 3.289  & 3.597  & 3.821  & $+$0.554 & $+$0.379 & $-$0.288 & 2.672 & 4.018 \\
post-shell outer           & 81.2  & $-$0.716 & $+$0.577 & $+$0.393 & 3.310  & 3.421  & 3.532  & $+$0.256 & $+$0.174 & $-$0.140 & 3.009 & 3.627 \\
mid-domain                 & 100.3 & $-$0.692 & $+$0.580 & $+$0.430 & 3.329  & 3.375  & 3.423  & $+$0.129 & $+$0.096 & $-$0.080 & 3.161 & 3.483 \\
far corner $(+,+,+)$        & 139.6 & $+$0.577 & $+$0.577 & $+$0.577 & 3.350  & 3.350  & 3.350  & $-$0.039 & $-$0.039 & $-$0.039 & 3.272 & 3.390 \\
far corner $(-,-,+)$        & 135.4 & $-$0.568 & $-$0.568 & $+$0.596 & 3.353  & 3.353  & 3.349  & $-$0.042 & $+$0.044 & $+$0.044 & 3.265 & 3.395 \\
balloon interior           &   3.2 & ---      & ---      & ---      & 0.001  & 0.001  & 0.001  & \phantom{$-$}0.000 & \phantom{$-$}0.000 & \phantom{$-$}0.000 & 0.001 & 0.001 \\
\bottomrule
\end{tabular}
\end{center}
...
\noindent Key patterns visible across the 15 voxels:
\begin{itemize}
\item \textbf{Rows 1--4 sit at the same radius $r=39.5$~mm on four different axes.}
      Eigenvalues are identical ($\mu_{rr},\mu_{\theta\theta}$ = 0.478,\,9.598~kPa
      for P1). But the Cartesian diagonals shuffle across $\mu_{zz}, \mu_{yy},
      \mu_{xx}$ depending on which axis $\hat r$ aligns with. Off-diagonals
      flip signs between $+z$ and $-z$ octants. All produced by the same
      rotation formula $\mu_{rr}\hat r\hat r^{\!\top} + \mu_{\theta\theta}(I - \hat r\hat r^{\!\top})$.
\item \textbf{Rows 5--8 are shell off-axis voxels in different octants.}
      Same radial physics, but off-diagonals reach $\pm 3.2$~kPa (P2 mid-shell)
      and change sign with $\hat r$'s octant.
\item \textbf{Rows 9--11 sweep outward.} Eigenvalues converge
      ($\mu_{rr} \to \mu_{\theta\theta}$) and off-diagonals shrink
      as $\lambda_\theta \to 1$.
\item \textbf{Rows 12--13, far corners in different octants.} Nearly
      isotropic ($\mu_{rr},\mu_{\theta\theta}$ within 4~\% of each
      other), residual off-diagonals of $\pm 0.04$~kPa reflect
      the residual acoustoelastic response at $r = 140$~mm.
\item \textbf{Row 14, balloon interior}: identity times $10^{-3}$~kPa.
\item \textbf{Eigenvalues always factor as} $[\mu_{rr}, \mu_{\theta\theta}, \mu_{\theta\theta}]$
      regardless of $\hat r$ — direct numerical check that the
      rotation is exactly $Q\,\mu_{\text{sph}}\,Q^{\!\top}$ everywhere.
\end{itemize}
