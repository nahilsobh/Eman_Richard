...
Phantom & GT $\mu_{\theta\theta}$ & $\mu_{\mathrm{conv}}$
        ...
        & [\si{\kilo\pascal}]     & — \\
\midrule
P1 & 4.93 & 2.46 & 3.21 & \textbf{1.31} \\
P2 & 6.12 & 2.71 & 3.51 & \textbf{1.30} \\
\midrule
...
Phantom & GT $\mu_{\theta\theta}$ [\si{\kilo\pascal}]
        ...
        & TSM/conv & TSM/GT \\
\midrule
P1 (neo-Hookean)     & 4.93 & 2.46 & 3.21 & 1.31 & 0.65 \\
P2 (matrix + fiber)  & 6.12 & 2.71 & 3.51 & 1.30 & 0.57 \\
\midrule
Yin measured (P1)    & --- & --- & $\sim$4.4 & 1.57 & --- \\
\bottomrule
\end{tabular}
...
\paragraph{Top-free BC.} Currently a ghost mirror $\partial u_c/\partial z = 0$
per component; this clamps normal strain, but the physical
$\sigma \cdot \vect n = 0$ clamps normal stress. Proper implementation
needs a one-sided stress stencil at the top face that solves for
$\partial u_c/\partial z$ from
\begin{equation*}
...
\end{equation*}
at each top-face voxel. FD stencil upgrade only; no new physics.
